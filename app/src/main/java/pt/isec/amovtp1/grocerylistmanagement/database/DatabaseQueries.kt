...
object DatabaseQueries {
    ...
    object SelectQueries : BaseColumns {
        ...
        const val SELECT_UNITS_WITH_SAME_NAME = "SELECT $UNIT_ID FROM $UNIT_TABLE_NAME WHERE $UNIT_NAME = ?"
        ...
        const val SELECT_ALL_PRODUCTS_ID_IN_LIST_PRODUCT_ORDER_BY_NAME_ASC = "SELECT $LIST_NAME, $LIST_DATE " +
                "FROM $LIST_TABLE_NAME ORDER BY $LIST_NAME ASC"

        const val SELECT_ALL_PRODUCTS_ID_IN_LIST_PRODUCT_ORDER_BY_NAME_DESC = "SELECT $LIST_NAME, $LIST_DATE " +
                "FROM $LIST_TABLE_NAME ORDER BY $LIST_NAME DESC"

        const val SELECT_ALL_PRODUCTS_ID_IN_LIST_PRODUCT_ORDER_BY_DATE_ASC = "SELECT $LIST_NAME, $LIST_DATE " +
                "FROM $LIST_TABLE_NAME ORDER BY $LIST_DATE ASC"

        const val SELECT_ALL_PRODUCTS_ID_IN_LIST_PRODUCT_ORDER_BY_DATE_DESC = "SELECT $LIST_NAME, $LIST_DATE " +
                "FROM $LIST_TABLE_NAME ORDER BY $LIST_DATE DESC"

        const val SELECT_ALL_PRODUCTS_ID_IN_LIST_PRODUCT_ORDER_BY_IS_BOUGHT_ASC = "SELECT $LIST_NAME, $LIST_DATE " +
                "FROM $LIST_TABLE_NAME ORDER BY $LIST_IS_BOUGHT ASC"

        const val SELECT_ALL_PRODUCTS_ID_IN_LIST_PRODUCT_ORDER_BY_IS_BOUGHT_DESC = "SELECT $LIST_NAME, $LIST_DATE " +
