...
object DatabaseQueries {
    ...
    object SelectQueries : BaseColumns {
        ...
        const val SELECT_NUM_CATEGORIES = "SELECT $CATEGORY_ID FROM $CATEGORY_TABLE_NAME"
        ...
        const val SELECT_UNIT_ID_BY_NAME = "SELECT $UNIT_ID FROM $UNIT_TABLE_NAME WHERE $UNIT_NAME LIKE ?"

        const val SELECT_BOUGHT_DATE_BY_LIST_NAME = "SELECT $LIST_DATE FROM $LIST_TABLE_NAME WHERE $LIST_NAME = ?"
        ...
        const val SELECT_ALL_PURCHASED_LISTS_ID = "SELECT $LIST_ID FROM $LIST_TABLE_NAME WHERE $LIST_IS_BOUGHT = 1"
        ...
        const val SELECT_LIST_INFO_ORDER_BY_NAME_ASC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME ORDER BY $LIST_NAME ASC"

        const val SELECT_NOT_PURCHASED_LIST_INFO_ORDER_BY_NAME_ASC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME WHERE $LIST_IS_BOUGHT = 0 ORDER BY $LIST_NAME ASC"

        const val SELECT_BOUGHT_LIST_INFO_ORDER_BY_NAME_ASC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME WHERE $LIST_IS_BOUGHT = 1 ORDER BY $LIST_NAME ASC"

        const val  SELECT_LIST_INFO_ORDER_BY_NAME_DESC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME ORDER BY $LIST_NAME DESC"

        const val SELECT_NOT_PURCHASED_LIST_INFO_ORDER_BY_NAME_DESC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME WHERE $LIST_IS_BOUGHT = 0 ORDER BY $LIST_NAME DESC"

        const val SELECT_BOUGHT_LIST_INFO_ORDER_BY_NAME_DESC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME WHERE $LIST_IS_BOUGHT = 1 ORDER BY $LIST_NAME DESC"

        const val  SELECT_LIST_INFO_ORDER_BY_DATE_ASC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME ORDER BY $LIST_DATE ASC"

        const val SELECT_NOT_PURCHASED_LIST_INFO_ORDER_BY_DATE_ASC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME WHERE $LIST_IS_BOUGHT = 0 ORDER BY $LIST_DATE ASC"

        const val SELECT_BOUGHT_LIST_INFO_ORDER_BY_DATE_ASC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME WHERE $LIST_IS_BOUGHT = 1 ORDER BY $LIST_DATE ASC"

        const val SELECT_LIST_INFO_ORDER_BY_DATE_DESC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME ORDER BY $LIST_DATE DESC"

        const val SELECT_NOT_PURCHASED_LIST_INFO_ORDER_BY_DATE_DESC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME WHERE $LIST_IS_BOUGHT = 0 ORDER BY $LIST_DATE DESC"

        const val SELECT_BOUGHT_LIST_INFO_ORDER_BY_DATE_DESC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME WHERE $LIST_IS_BOUGHT = 1 ORDER BY $LIST_DATE DESC"

        const val  SELECT_LIST_INFO_ORDER_BY_IS_BOUGHT_ASC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
                "FROM $LIST_TABLE_NAME ORDER BY $LIST_IS_BOUGHT ASC"

        const val  SELECT_LIST_INFO_ORDER_BY_IS_BOUGHT_DESC = "SELECT $LIST_NAME, $LIST_DATE, $LIST_IS_BOUGHT " +
        ...
        const val SELECT_CATEGORY_ID_BY_NAME = "SELECT $CATEGORY_ID FROM $CATEGORY_TABLE_NAME WHERE $CATEGORY_NAME LIKE ?"
    }
